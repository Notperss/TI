        ...
        <div class="content-wrapper">
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
                    <h3 class="content-header-title mb-0 d-inline-block">Jobdesk</h3>
                ...
                <section id="add-home">
                    <div class="row">
                        <div class="col-12">
                            ...
                            <a href="{{ route('backsite.jobdesk.create') }}" class="btn btn-success col-2 mb-2">
                                Tambah Jobdesk</a>
                            {{--  <div class="card">
                                ...
                                <div class="card-content collapse hide">
                                    <div class="card-body card-dashboard">
                                        ...
                                        <form class="form form-horizontal"
                                            action="{{ route('backsite.jobdesk.store') }}" method="POST"
                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <select name="jobdesk" id="jobdesk"
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">List Jobdesk</h4>
                                ...
                                <div class="card-body card-dashboard">
                                    ...
                                    <div class="table-responsive">
                                        <table
                                            ...
                                            <tbody>
                                                @forelse($jobdesk as $key => $jobdesk_item)
                                                    <tr data-entry-id="{{ $jobdesk_item->id }}">
                                                        <td class="text-center">{{ $loop->iteration }}</td>
                                                        <td class="text-center">
                                                            @if ($jobdesk_item->jobdesk == 1)
                                                                <span
                                                                    class="badge badge-success">{{ 'Teknologi Informasi' }}</span>
                                                            @elseif($jobdesk_item->jobdesk == 2)
                                                                <span class="badge badge-warning">{{ 'Hardware' }}</span>
                                                            @elseif($jobdesk_item->jobdesk == 3)
                                                                <span
                                                                    class="badge badge-secondary">{{ 'Jaringan' }}</span>
                                                            @elseif($jobdesk_item->jobdesk == 4)
                                                                <span
                                                                    class="badge badge-danger">{{ 'Peralatan Tol' }}</span>
                                                            @elseif($jobdesk_item->jobdesk == 5)
                                                                <span
                                                        ...
                                                        <td class="text-center">{{ $jobdesk_item->year ?? '' }}
                                                        </td>
                                                        <td class="text-center">
                                                            {{ $jobdesk_item->general ?? '' }}
                                                        </td>
                                                        <td class="text-center">
                                                            {{ $jobdesk_item->technical ?? '' }}
                                                        </td>
                                                        <td class="text-center">
                                                            @if ($jobdesk_item->type == 1)
                                                                <span
                                                                    class="badge badge-success">{{ 'Rutin' }}</span>
                                                            @elseif($jobdesk_item->type == 2)
                                                        ...
                                                        <td class="text-center">
                                                            @if ($jobdesk_item->status == 1)
                                                                <span
                                                                    class="badge badge-success">{{ 'Aktif' }}</span>
                                                            @elseif($jobdesk_item->status == 2)
                                                        ...
                                                        <td class="text-center">
                                                            <div class="btn-group mr-1 mb-1">
                                                                ...
                                                                <div class="dropdown-menu" aria-labelledby="btnGroupDrop2">
                                                                    <a href="#mymodal"
                                                                        data-remote="{{ route('backsite.jobdesk.show', encrypt($jobdesk_item->id)) }}"
                                                                        data-toggle="modal" data-target="#mymodal"
                                                                        data-title="Detail jobdesk" class="dropdown-item">
                                                                        Show
                                                                    </a>
                                                                    <a class="dropdown-item"
                                                                        href="{{ route('backsite.jobdesk.edit', encrypt($jobdesk_item->id)) }}">
                                                                        Edit
                                                                    </a>
                                                                    <form
                                                                        action="{{ route('backsite.jobdesk.destroy', encrypt($jobdesk_item->id)) }}"
                                                                        method="POST"
