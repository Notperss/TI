              ...
              <div class="card">
                ...
                <div class="card-content collpase show">
                  <div class="card-body">
                    ...
                    <form class="form form-horizontal" action="{{ route('backsite.jobdesk.update', [$jobdesk->id]) }}"
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-md-4">
                            <select name="jobdesk" id="jobdesk" class="form-control select2" required>
                              ...
                              <option value="1" {{ $jobdesk->jobdesk == 1 ? 'selected' : '' }}>
                                Teknologi Informasi</option>
                              <option value="2" {{ $jobdesk->jobdesk == 2 ? 'selected' : '' }}>
                                Hardware</option>
                              <option value="3" {{ $jobdesk->jobdesk == 3 ? 'selected' : '' }}>
                                Jaringan</option>
                              <option value="4" {{ $jobdesk->jobdesk == 4 ? 'selected' : '' }}>
                                Peralatan Tol</option>
                              <option value="5" {{ $jobdesk->jobdesk == 5 ? 'selected' : '' }}>
                          ...
                          <div class="col-md-4">
                            <input type="text" class="form-control" name="year" id="year"
                              ...
                              value="{{ isset($jobdesk->year) ? $jobdesk->year : '' }}" autocomplete="off">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-md-4">
                            <select name="type" id="type" class="form-control select2" required>
                              ...
                              <option value="1" {{ $jobdesk->type == '1' ? 'selected' : '' }}>
                                Rutin</option>
                              <option value="2" {{ $jobdesk->type == '2' ? 'selected' : '' }}>
                                Target</option>
                            </select>
                          ...
                          <div class="col-md-4">
                            <select name="status" id="status" class="form-control select2" required>
                              ...
                              <option value="1" {{ $jobdesk->status == 1 ? 'selected' : '' }}>Aktif
                              </option>
                              <option value="2" {{ $jobdesk->status == 2 ? 'selected' : '' }}>Tidak
                                Aktif</option>
                            </select>
