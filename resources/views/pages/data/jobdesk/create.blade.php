                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    <input type="text" class="form-control" name="year" id="year"
                                        ...
                                        autocomplete="off" value="{{ old('year') }}" required>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    <select name="type" id="type" class="form-control select2" required>
                                        ...
                                        <option value="1"
                                            @if (old('type') == 1) {{ 'selected' }} @endif>Rutin</option>
                                        <option value="2"
                                            @if (old('type') == 2) {{ 'selected' }} @endif>target</option>
                                ...
                                <div class="col-md-4">
                                    <select name="status" id="status" class="form-control select2" required>
                                        ...
                                        <option value="1"
                                            @if (old('status') == 1) {{ 'selected' }} @endif>Aktif</option>
                                        <option value="2"
                                            @if (old('status') == 2) {{ 'selected' }} @endif> Tidak Aktif
                                        </option>
                                    </select>
