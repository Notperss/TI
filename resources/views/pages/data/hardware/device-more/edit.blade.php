...
{{-- set title --}}
@section('title', 'Edit - Device More')
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header row">
                <div class="mb-2 content-header-left col-md-6 col-12 breadcrumb-new">
                    <h3 class="mb-0 content-header-title d-inline-block">Edit Device More</h3>
                    <div class="row breadcrumbs-top d-inline-block">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item">Dashboard</li>
                                <li class="breadcrumb-item">Device More</li>
                                        ...
                                        <form class="form form-horizontal"
                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-md-2 label-control" for="type_device_id">Monitor
                                                        ...
                                                        <select name="type_device_id" id="type_device_id"
                                                            ...
                                                            @foreach ($type_device as $key => $type_device_item)
                                                                <option value="{{ $type_device_item->id }}"
                                                                    {{ $type_device_item->id == $device_more->type_device_id ? 'selected' : '' }}>
