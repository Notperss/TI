...
{{-- set title --}}
@section('title', 'Edit - Device Additional')
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header row">
                <div class="mb-2 content-header-left col-md-6 col-12 breadcrumb-new">
                    <h3 class="mb-0 content-header-title d-inline-block">Edit Device Additional</h3>
                    <div class="row breadcrumbs-top d-inline-block">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item">Dashboard</li>
                                <li class="breadcrumb-item">Device Additional</li>
                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-md-2 label-control"
                                                        for="additional_device_id">Perangkat Tambahan
                                                        ...
                                                        <select name="additional_device_id" id="additional_device_id"
                                                            ...
                                                            @foreach ($additional as $key => $additional_item)
                                                                <option value="{{ $additional_item->id }}"
                                                                    {{ $additional_item->id == $device_additional->additional_device_id ? 'selected' : '' }}>
