            ...
            <div class="col-12">
              ...
              <div class="card">
                <div class="card-header bg-success text-white">
                  <h4 class="card-title text-white">Tambah Data PC </h4>
                </div>
                  ...
                  <form class="form" action="{{ route('backsite.device_pc.store') }}" method="POST"
                    ...
                    <div class="form-body">
                      ...
                      <div class="form-group row">
                        <label class="col-md-1 label-control" for="motherboard_id">
                          Motherboard<code style="color:red;">*</code></label>
                        <div class="col-md-5">
                          <select name="motherboard_id" id="motherboard_id" class="form-control select2" required>
                        ...
                        <label class="col-md-1 label-control" for="processor_id">
                          Processor<code style="color:red;">*</code></label>
                        <div class="col-md-5">
                          <select name="processor_id" id="processor_id" class="form-control select2" required>
                            <option value="{{ '' }}" disabled selected>
                              Choose
                            </option>
                      ...
                      <div class="form-group row">
                        <label class="col-md-1 label-control" for="ram_id">
                          Ram<code style="color:red;">*</code></label>
                        <div class="col-md-5">
                          <label for="role">
                          ...
                          <select name="ram_id[]" id="role" class="form-control select2-full-bg" data-bgcolor="teal"
                            data-bgcolor-variation="lighten-3" data-text-color="black" multiple="multiple" required>
                        ...
                        <label class="col-md-1 label-control" for="hardisk_id">
                          Hardisk<code style="color:red;">*</code></label>
                        <div class="col-md-5">
                          <label for="roel">
                            <span class="btn btn-warning btn-sm select-all">{{ 'Select all' }}</span>
                            <span class="btn btn-warning btn-sm deselect-all">{{ 'Delete all' }}</span>
                      ...
                      <div class="form-group row">
                        <label class="col-md-1 label-control" for="no_asset">
                          No Asset
                        ...
                        <label class="col-md-1 label-control" for="file">File</label>
                        <div class="col-md-5">
                      ...
                      <div class="form-group row">
                        <label class="col-md-1 label-control" for="description">Keterangan</label>
                        <div class="col-md-11">
                    ...
                    <div class="form-actions ">
                      ...
                      <a href="{{ route('backsite.device_pc.index') }}" class="btn btn-success text-left ml-2">
...
@endpush
@push('after-script')
  <script script src="https://cdn.jsdelivr.net/npm/summernote@0.8.18/dist/summernote-bs4.min.js"></script>
  <script>
    // summernote
