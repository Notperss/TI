                        ...
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-header bg-success text-white my-1">
                                    <h4 class="card-title text-white">Tambah Aktivitas Harian</h4>
                                </div>

                                <form class="form form-horizontal"
                                    action="{{ route('backsite.act_daily.update', [$actdaily->id]) }}" method="POST"
                                    ...
                                    <div class="form-body">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-md-2 label-control" for="activity">Kegiatan<code
                                                    style="color:red;">*</code></label>
                                            <div class="col-md-10">
                                                <textarea rows="5" class="form-control" id="activity" name="activity" required> {{ $actdaily->activity }}</textarea>
                                        ...
                                        <div class="form-group row">
                                            <label class="col-md-2 label-control" for="description">Catatan<code
                                                    style="color:red;"></code></label>
                                            <div class="col-md-10">
                                                <textarea rows="5" class="form-control" id="description" name="description">{{ $actdaily->description }}</textarea>
                                    ...
                                    <div class="form-actions ">
                                        ...
                                        <a href="{{ route('backsite.act_daily.index') }}"
