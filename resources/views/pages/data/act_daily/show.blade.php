<table class="table table-bordered">
    ...
    <tr>
        <th>Tanggal Mulai</th>
        <td>{{ isset($actdaily->start_date) ? Carbon\Carbon::parse($actdaily->start_date)->translatedFormat('l, d F Y H:i') : 'N/A' }}
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>{{ isset($actdaily->finish_date) ? Carbon\Carbon::parse($actdaily->finish_date)->translatedFormat('l, d F Y H:i') : 'N/A' }}
        </td>
    </tr>
    <tr>
        <th>Catatan</th>
    ...
    <tr>
        <th>Status</th>
        <td>
            @if ($actdaily->status == 1)
                <span class="badge badge-success">{{ 'Aktif' }}</span>
            @elseif($actdaily->status == 2)
