                ...
                <div class="card-content collapse show">
                  <div class="card-body card-dashboard">
                    ...
                    <div class="table-responsive ">
                      <table class="table table-striped table-bordered text-inputs-searching default-table  bg-info">
                        <thead class="default">
                          <tr class="text-white">
                            ...
                            <tr data-entry-id="{{ $user_item->id }}">
                              ...
                              <td class="text-center">
                                ...
                                @elseif($user_item->detail_user->job_position == 7 ? 'selected' : '')
                                  <span class="badge badge-primary">{{ 'Senior Officer' }}</span>
                                @else
                                  <span>{{ 'N/A' }}</span>
                                @endif
                              </td>
                              ...
                              @if ($user_item->detail_user->icon)
                                <td class="text-center"><img
                                    src="{{ asset('storage/' . $user_item->detail_user->icon) }}" alt="Icon User"
                                    width="50px">
                                </td>
                              @else
                                <td class="text-center">
                              ...
                              <td class="text-center">
                                <div class="btn-group mr-1 mb-1">
                                  ...
                                  <div class="dropdown-menu">
                                    ...
                                    <form action="{{ route('backsite.user.destroy', encrypt($user_item->id)) }}"
