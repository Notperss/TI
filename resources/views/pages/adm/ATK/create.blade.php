          ...
          <div class="row">
            <div class="col-12">
              <div class="card">
                ...
                <form class="form" action="{{ route('backsite.atk.store') }}" method="POST"
                  ...
                  <div class="form-body container">
                    ...
                    <div class="form-group row">
                      <label class="col-md-2 label-control" for="usage">Pemakaian<code
                          style="color:red;">*</code></label>
                      <div class="col-md-7">
                        <textarea rows="5" class="form-control summernote" id="usage" name="usage" required>{{ old('usage') }}</textarea>
                        @if ($errors->has('usage'))
                          <p style="font-style: bold; color: red;">
