            ...
            <div class="col-12">
              <div class="card">
                ...
                <div class="card-header bg-success">
                  <h4 class="card-title text-white">Edit Permintaan Uang</h4>
                </div>
                <form class="form" action="{{ route('backsite.demand.update', $demand->id) }}" method="POST"
                  ...
                  <div class="form-body container">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-md-4">
                        <input type="text" class="form-control" name="no_demand" id="no_demand"
                          value="{{ old('no_demand', $demand->no_demand) }}">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-md-4">
                        <input type="text" class="form-control" name="nominal" id="nominal"
                          value="{{ old('nominal', $demand->nominal) }}">
                      ...
                      <div class="col-md-4">
                        <input type="date" id="date_demand" name="date_demand" class="form-control"
                          value="{{ old('date_demand', $demand->date_demand) }}" autocomplete="off">
                    ...
                    <div class="form-group row">
                      <label class="col-md-2 label-control" for="description">Keterangan<code
                          style="color:red;">*</code></label>
                      <div class="col-md-10">
                        <textarea rows="5" class="form-control summernote" id="description" name="description">{{ old('description', $demand->description) }}</textarea>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-md-4">
                        <input type="text" class="form-control" name="accountability" id="accountability"
                          value="{{ old('accountability', $demand->accountability) }}">
                      ...
                      <div class="col-md-4">
                        <input type="date" id="date_pj" name="date_pj" class="form-control"
                          value="{{ old('date_pj', $demand->date_pj) }}" autocomplete="off">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-md-4">
                        <input type="text" class="form-control" name="nominal_pj" id="nominal_pj"
                          value="{{ old('nominal_pj', $demand->nominal_pj) }}">
