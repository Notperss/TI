            ...
            <div class="col-12">
              <div class="card">
                ...
                <div class="card-header bg-success text-white my-1">
                  <h4 class="card-title text-white">Edit Jenis Peralatan</h4>
                </div>

                <form class="form form-horizontal" action="{{ route('backsite.type-asset.update', $typeAsset) }}"
                  ...
                  <div class="form-body">
                    ...
                    <div class="form-group row col-10">
                      ...
                      <div class="col-md-9 mx-auto">
                        <input type="text" id="name" name="name" class="form-control" placeholder=""
                          value="{{ old('name', $typeAsset->name) }}" autocomplete="off" autofocus required>
                      </div>
                      @if ($errors->has('name'))
                    ...
                    <div class="form-group row col-10">
                      ...
                      <div class="col-md-9 mx-auto">
                        <textarea class="form-control" id="description" name="description" rows="5">{{ old('description', $typeAsset->description) }}</textarea>
                      </div>
                    ...
                    {{-- <div class="form-group row col-10">
                      ...
                      <div class="col-md-2">
                        <select name="status" id="status" class="form-control select2" required>
                          ...
                          <option value="1" {{ $typeAsset->status == 1 ? 'selected' : '' }}>
                            Aktif
                          </option>
                          <option value="2" {{ $typeAsset->status == 2 ? 'selected' : '' }}>
                            Tidak Aktif</option>
                        </select>
                      </div>
