              ...
              <div class="card">
                ...
                <div class="card-content collpase show">
                  <div class="card-body">
                    ...
                    <form class="form form-horizontal" action="{{ route('backsite.employee.update', [$employee->id]) }}"
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-md-9 mx-auto">
                            <input type="text" id="nip" name="nip" class="form-control"
                              value="{{ old('nip', isset($employee->nip) ? $employee->nip : '') }}" autocomplete="off"
                              required>
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-md-9 mx-auto">
                            <input type="text" id="name" name="name" class="form-control"
                              value="{{ old('name', isset($employee->name) ? $employee->name : '') }}" autocomplete="off"
                              required>
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-md-9 mx-auto">
                            <select name="type_user" id="type_user" class="form-control select2" required>
                              ...
                              <option value="1" {{ $employee->type_user == 1 ? 'selected' : '' }}>
                                User</option>
                              <option value="2" {{ $employee->type_user == 2 ? 'selected' : '' }}>
                                Divisi</option>
                            </select>
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-md-9 mx-auto">
                            <select name="status" id="status" class="form-control select2">
                              ...
                              <option value="1" {{ $employee->status == 1 ? 'selected' : '' }}>Aktif
                              </option>
                              <option value="2" {{ $employee->status == 2 ? 'selected' : '' }}>Tidak
                                Aktif</option>
                            </select>
