                                        ...
                                        <div class="form-body">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9 mx-auto">
                                                    <input type="text" id="nip" name="nip" class="form-control"
                                                        placeholder="example John Doe or Jane" value="{{ old('nip') }}"
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9 mx-auto">
                                                    <input type="text" id="company" name="company" class="form-control"
                                                        placeholder="example John Doe or Jane" value="{{ old('company') }}"
                                                        autocomplete="off" required>
                                            ...
                                            <div class="form-group row">
                                                <label class="col-md-3 label-control" for="type_user">Tipe User
                                                    <code style="color:red;">*</code></label>
                                                <div class="col-md-9 mx-auto">
                                                    <select name="type_user" id="type_user" class="form-control select2"
                                                        required>
                                                        <option value="{{ '' }}" disabled selected>
                                                            Choose
                                                        </option>
