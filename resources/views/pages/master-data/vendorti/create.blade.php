                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                ...
                                <form class="form form-horizontal" action="{{ route('backsite.vendor_ti.store') }}"
                                        ...
                                        <div class="form-group row col-10">
                                            ...
                                            <div class="col-md-9 mx-auto">
                                                <input type="text" id="nama_vendor" name="nama_vendor"
                                                    class="form-control" placeholder="" value="{{ old('nama_vendor') }}"
                                        ...
                                        <div class="form-group row col-10">
                                            ...
                                            <div class="col-md-9 mx-auto">
                                                <input type="text" id="telp" name="telp" class="form-control"
                                                    placeholder="" value="{{ old('telp') }}" autocomplete="off" autofocus
                                                    required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row col-10">
                                            ...
                                            <div class="col-md-9 mx-auto">
                                                <input type="text" id="pic" name="pic" class="form-control"
                                                    placeholder="" value="{{ old('pic') }}" autocomplete="off" autofocus
                                                    required>
                                            </div>
                                        </div>
