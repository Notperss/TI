                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <input type="text" id="latitude" name="latitude"
                                                            class="form-control"
                                                            value="{{ old('latitude', isset($location_detail->latitude) ? $location_detail->latitude : '') }}"
                                                            autocomplete="off">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <input type="text" id="longitude" name="longitude"
                                                            class="form-control"
                                                            value="{{ old('longitude', isset($location_detail->longitude) ? $location_detail->longitude : '') }}"
                                                            autocomplete="off">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <select name="status" id="status"
                                                            ...
                                                            <option value="1"
                                                                {{ $location_detail->status == 1 ? 'selected' : '' }}>Aktif
                                                            </option>
                                                            <option value="2"
                                                                {{ $location_detail->status == 2 ? 'selected' : '' }}>Tidak
                                                                Aktif</option>
                                                        </select>
