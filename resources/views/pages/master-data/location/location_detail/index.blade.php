                ...
                <section id="add-home">
                    <div class="row">
                        <div class="col-12">
                            ...
                            <a href="{{ route('backsite.location_detail.create') }}"
                                class="btn btn-success col-2 mb-1">Tambah
                                Detail Lokasi</a>
                                                ...
                                                <tbody>
                                                    @forelse($location_detail as $key => $location_detail_item)
                                                        <tr data-entry-id="{{ $location_detail_item->id }}">
                                                            ...
                                                            <td class="text-center">
                                                                @if ($location_detail_item->status == 1)
                                                                    <span
                                                                        class="badge badge-success">{{ 'Aktif' }}</span>
                                                                @elseif($location_detail_item->status == 2)
                                                                    <span
