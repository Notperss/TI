                                ...
                                <div class="card-content collpase show">
                                    <div class="card-body">
                                        <form class="form form-horizontal"
                                            action="{{ route('backsite.additional_device.update', [$additional_device->id]) }}"
                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="mx-auto col-md-9">
                                                        <input type="text" id="name" name="name"
                                                            ...
                                                            value="{{ old('name', isset($additional_device->name) ? $additional_device->name : '') }}"
                                                    ...
                                                    <div class="mx-auto col-md-9">
                                                        <select name="category" id="category" class="form-control select2"
                                                            ...
                                                            <option value="Keyboard"
                                                                {{ $additional_device->category == 'Keyboard' ? 'selected' : '' }}>
                                                                Keyboard
                                                            </option>
                                                            <option value="Mouse"
                                                                {{ $additional_device->category == 'Mouse' ? 'selected' : '' }}>
                                                                Mouse</option>
                                                            <option value="Webcam"
                                                                {{ $additional_device->category == 'Webcam' ? 'selected' : '' }}>
                                                                Webcam</option>
                                                            <option value="Switch kecil"
                                                                {{ $additional_device->category == 'Switch kecil' ? 'selected' : '' }}>
                                                                Switch Kecil</option>
                                                            <option value="Mikrotik kecil"
                                                                {{ $additional_device->category == 'Mikrotik kecil' ? 'selected' : '' }}>
                                                                Mikrotik Kecil</option>
                                                        </select>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="mx-auto col-md-9">
                                                        <input type="text" id="specification" name="specification"
                                                            ...
                                                            value="{{ old('specification', isset($additional_device->specification) ? $additional_device->specification : '') }}"
                                                            autocomplete="off">
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-md-3 label-control" for="file">Ganti File
                                                        <code style="color:red;">optional</code></label>
                                                    <div class="mx-auto col-md-9">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="mx-auto col-md-9">
                                                        <select name="status" id="status"
                                                            ...
                                                            <option value="1"
                                                                {{ $additional_device->status == 1 ? 'selected' : '' }}>
                                                                Aktif</option>
                                                            <option value="2"
                                                                {{ $additional_device->status == 2 ? 'selected' : '' }}>
                                                                Tidak Aktif</option>
                                                        </select>
                                            ...
                                            <div class="text-right form-actions">
                                                <a href="{{ route('backsite.additional_device.index') }}"
