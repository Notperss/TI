            ...
            <div class="col-12">
              <div class="card">
                ...
                <div class="card-header bg-success text-white my-1">
                  <h4 class="card-title text-white">Tambah RAM</h4>
                </div>
                <form class="form form-horizontal" action="{{ route('backsite.ram.store') }}" method="POST"
                    ...
                    <div class="form-group row">
                      ...
                      <div class="mx-auto col-md-9">
                        <input type="text" id="name" name="name" class="form-control"
                          placeholder="isi nama ram disini" value="{{ old('name') }}" autocomplete="off" required>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="mx-auto col-md-9">
                        <input type="text" id="size" name="size" class="form-control"
                          placeholder="isi ukuran/kapasitas ram" value="{{ old('size') }}" autocomplete="off" required>
                  ...
                  <div class="form-actions ">
                    ...
                    <a href="{{ route('backsite.ram.index') }}" class="btn btn-success text-left ml-2">
