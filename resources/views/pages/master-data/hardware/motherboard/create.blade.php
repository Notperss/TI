          ...
          <div class="row">
            <div class="col-12">
              <div class="card">
                ...
                <form class="form form-horizontal" action="{{ route('backsite.motherboard.store') }}" method="POST"
                    ...
                    <div class="form-group row">
                      ...
                      <div class="mx-auto col-md-9">
                        <input type="text" id="name" name="name" class="form-control"
                          placeholder="example Asus" value="{{ old('name') }}" autocomplete="off" required>
                  ...
                  <div class="form-actions ">
                    ...
                    <a href="{{ route('backsite.motherboard.index') }}" class="btn btn-success text-left ml-2">
