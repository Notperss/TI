        ...
        <div class="content-wrapper">
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
                    <h3 class="content-header-title mb-0 d-inline-block">Edit Software</h3>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <select name="software_category" id="software_category"
                                                            ...
                                                            <option value="1"
                                                                {{ $software->software_category == 1 ? 'selected' : '' }}>Os
                                                            </option>
                                                            <option value="2"
                                                                {{ $software->software_category == 2 ? 'selected' : '' }}>
                                                                Office</option>
                                                            <option value="3"
                                                                {{ $software->software_category == 3 ? 'selected' : '' }}>
                                                                Software Lisensi</option>
                                                            <option value="4"
                                                                {{ $software->software_category == 4 ? 'selected' : '' }}>
                                                                Kall</option>
                                                            <option value="5"
                                                                {{ $software->software_category == 5 ? 'selected' : '' }}>
                                                                Lain-lain</option>
                                                        </select>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <input type="text" id="software_type" name="software_type"
                                                            class="form-control"
                                                            value="{{ old('software_type', isset($software->software_type) ? $software->software_type : '') }}"
                                                            autocomplete="off" required>
                                                    ...
                                                    <div class="col-md-4">
                                                        <input type="text" id="variant" name="variant"
                                                            ...
                                                            value="{{ old('name', isset($software->variant) ? $software->variant : '') }}"
                                                            autocomplete="off">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <select name="license_type" id="license_type"
                                                            ...
                                                            <option value="1"
                                                                {{ $software->license_type == 1 ? 'selected' : '' }}>
                                                                Perpetual</option>
                                                            <option value="2"
                                                                {{ $software->license_type == 2 ? 'selected' : '' }}>
                                                                Subscribe</option>
                                                        </select>
