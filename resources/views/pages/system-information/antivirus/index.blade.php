    ...
    <div class="content-wrapper">
      ...
      <div class="content-header row">
        <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
          <h3 class="content-header-title mb-0 d-inline-block">Antivirus</h3>
        ...
        <section id="add-home">
          <div class="row">
            <div class="col-12">
              ...
              <a href="{{ route('backsite.antivirus.create') }}" class="btn btn-success col-2 mb-2">
                Tambah Data Antivirus</a>
            </div>
          </div>
        </section>
      </div>
            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  <h4 class="card-title">List Antivirus</h4>
...
@push('after-script')
  ...
  <script>
    ...
    var table = $('#antivirus-table').DataTable({
      processing: true,
      serverSide: true,
      ordering: false,
      lengthChange: false,
      ...
      ajax: {
        url: "{{ route('backsite.antivirus.index') }}",
        data: function(data) {
          if (dateFilterActive) {
