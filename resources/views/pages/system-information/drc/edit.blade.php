          ...
          <div class="row">
            <div class="col-12">
              <div class="card">
                ...
                <form class="form" action="{{ route('backsite.drc.update', $drc->id) }}" method="POST"
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-md-4">
                        <input type="text" class="form-control" name="name" id="name"
                          value="{{ old('name', $drc->name) }}" required>
                        @if ($errors->has('name'))
                      ...
                      <div class="col-md-4">
                        <input type="text" name="path_source" id="path_source" class="form-control"
                          value="{{ old('path_source', $drc->path_source) }}" required>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-md-4">
                        <input type="text" name="path_backup" id="path_backup" class="form-control"
                          value="{{ old('path_backup', $drc->path_backup) }}" required>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-md-4">
                        <input type="text" name="path_drc" id="path_drc" class="form-control"
                          value="{{ old('path_drc', $drc->path_drc) }}" required>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-md-4">
                        <input type="text" name="backup_time" id="backup_time" class="form-control"
                          value="{{ old('backup_time', $drc->backup_time) }}" required>
