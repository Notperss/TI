                  ...
                  <div class="form-body container">
                    ...
                    <div class="form-group row">
                      <label class="col-md-2 label-control" for="description">Keterangan<code
                          style="color:red;">*</code></label>
                      <div class="col-md-10">
                        <textarea rows="5" class="form-control" id="description" name="description" required>{{ old('description', $app->description) }}</textarea>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-md-3">
                        <select name="is_active" id="is_active" class="form-control select2">
                          ...
                          <option value="0"{{ $app->is_active == 0 ? 'selected' : '' }}>Tidak Aktif
                          </option>
                        </select>
