  ...
  <div class="modal fade" id="upload" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <form class="form" action="{{ route('backsite.maintenance.add_status') }}" method="POST"
          ...
          <div class="modal-body">
            ...
            <div class="form-group row">
              <label class="col-md-4 label-control" for="users_id">Petugas<code style="color:red;">*</code></label>
              <div class="col-md-8">
