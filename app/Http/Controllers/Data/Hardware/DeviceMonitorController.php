...
class DeviceMonitorController extends Controller
{
    ...
    {
        $device_monitor = DeviceMonitor::all();
        return view('pages.data.hardware.device-monitor.index', compact('device_monitor'));
    }
    ...
    {
        return view('pages.data.hardware.device-monitor.create');
    }
    ...
    public function edit($id)
    {
        ...
        // return view('pages.data.hardware.device-monitor.edit', compact('device_monitor', 'monitor'));
    }
