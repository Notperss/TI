...
class DeviceController extends Controller
{
    ...
    {
        // device_pc
        $device_pc = DevicePc::with(['motherboard', 'processor', 'ram', 'hardisk'])->latest()->get();
        ...
        return view('pages.data.hardware.device.index', compact('device_pc', 'motherboard', 'processor', 'ram', 'hardisk', 'device_monitor', 'monitor', 'device_additional', 'additional', 'kd', 'device_more', 'type_device'));
    }
